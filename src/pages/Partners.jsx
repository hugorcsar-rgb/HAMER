...
// TODO: Replace with a Bobby Jones / classic golf scene image
      ...
      <section className="w-full premium-spacing border-t border-foreground/10">
        <div className="max-w-[1200px] mx-auto grid md:grid-cols-12 gap-12">
          ...
          <div className="md:col-span-8 font-heading text-foreground/90 leading-[1.45] space-y-6" style={{ fontSize: 'clamp(1.25rem, 1.8vw, 1.625rem)' }}>
            <p>
              We are former international students who played junior and elite
              amateur golf at the highest level our age and access allowed. We
              crossed borders for this sport before it crossed continents for us.
            </p>
            <p>
              That history matters because we have seen, from the inside, how
              this industry works — the firms that quote a price for an outcome
              they cannot promise, the advisors who have never been recruited
              themselves, and those who treat a family's once-in-a-lifetime
              decision like a transaction.
            </p>
            <p>
              HAMER exists because we know what good looks like in this work,
              and we know how rare it is. We are here to make an impact —
              quietly, with the standard of care we wish someone had brought to
              our own families when it was our turn.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="w-full premium-spacing border-t border-foreground/10">
        <div className="max-w-[1200px] mx-auto grid md:grid-cols-12 gap-12">
          <div className="md:col-span-4">
            ...
            <h2 className="font-heading text-section leading-tight">
              An institutional <span className="italic text-accent">house of standards</span>.
            </h2>
          </div>
          <div className="md:col-span-8 font-body text-body text-foreground/85 leading-relaxed space-y-5">
            <p>
              The programs and institutions listed below have either partnered
              with HAMER on specific engagements or have served as proving
              grounds for the methodology that the firm applies today. They span
              private clubs, summer camps, and national programs across the U.S.
              and Mexico.
            </p>
            <p>
              HAMER continues to expand its partnership network with golf
              clubs, junior academies, and summer camps committed to
              professionalizing their programs. Partnership inquiries are
              welcome through the Inquire page.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="w-full premium-spacing border-t border-foreground/10">
        <div className="max-w-[1200px] mx-auto text-center flex flex-col items-center gap-12">
          ...
          <div className="flex flex-wrap justify-center gap-8 md:gap-16">
            {trustedPrograms.map((name, i) => (
              <p key={i} className="font-heading text-xl md:text-2xl text-foreground/80">{name}</p>
            ))}
          </div>
        </div>
      </section>
      ...
      <section id="become-a-partner" className="w-full premium-spacing border-t border-foreground/10">
        <div className="max-w-[1200px] mx-auto">
          ...
          <p className="font-body text-body text-foreground/85 leading-relaxed max-w-3xl mb-10">
            Clubs, academies, and camps that share our standards are invited to
            explore long-term partnerships. If you operate a junior tournament,
            an academy, a camp, a coach education program, or a college
            pipeline — and you are building something built to endure — we
            would like to hear from you.
          </p>
          <div className="flex flex-wrap gap-4">
            <Link
              to="/inquire?topic=partnership"
            ...
            >
              ...
              href="mailto:info@hamergolfconsulting.com?subject=Partnership%20inquiry"
